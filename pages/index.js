    ...
    <>
      <div className="sticky font-kaisei">
        ...
        <section className="flex flex-col justify-center items-center  lg:m-24">
          ...
          <SubLayout title={'厳選宮崎ブランド豚肉使用'} src={image2} content={'当店人気の餃子は消費量2021年宇都宮、浜松を抜いて日本一になった宮崎県の宮崎ギョーザです。人気を支えるのは厳選された宮崎ブランド豚肉を使用している点にあります。産地の方々の厳しいチェックのもと、送り出された最高級国産豚の旨みをご堪能ください。'} />
          <SubLayout title={'豊かな土壌で育った宮崎野菜'} src={image3} content={'生にんにくは宮崎県佐土原町(株)MOMIKIさん使用、生しょうがも宮崎県佐土原町の福田農園さんを使用しています。宮崎の豊かな土壌で育った作物は旨味成分と栄養価たっぷり'} />
          <SubLayout title={'簡単に本場のハネを再現！'} src={image4} content={'フライパンを熱し油を適量ひきます、火を消して凍ったまま餃子を並べて強火で水２００ｃｃを餃子の上から全体に注いでください、フタをして7分前後でパチパチと水分が飛んだら出来上がりです。「目安は28センチフライパンで10～20個が200cc」'} />
        ...
        <section className="flex flex-col justify-center items-center lg:m-24" id={"no4"}>
          ...
          <MainLayout src={image9} content={'火力を強火にして水2００ccを餃子の上から全体にまんべんなく注いでください'} />
