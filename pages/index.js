    ...
    <>
      <div className="sticky font-kaisei">
        ...
        <section className="flex flex-col justify-center items-center lg:m-24">
          ...
          <SubLayout title={'選び抜いた宮崎ブランド豚肉使用'} src={image2} content={'ここはPCだと2カラムの右側、スマホだと1カラムになりますここはPCだと2カラムの右側、ここはPCだと2カラムの右側、スマホだと1カラムになりますここはPCだと2カラムの右側、スマホだと1カラムになりますここはPCだと2カラムの右側、 スマホだと1カラムになりますここはPCだと2カラムの右側、スマホだと1カラムになります ここはPCだと2カラムの右側、スマホだと1カラムになりますここはPCだと2カラムの右側、'} />
          <SubLayout title={'宮崎の豊かな土壌で育った野菜をチョイス'} src={image3} content={'生にんにくは宮崎県佐土原町(株)MOMIKIさん使用、生ショウガも宮崎県佐土原町の福田農園さんを使用しています。生にんにくは宮崎県佐土原町(株)MOMIKIさん使用、生ショウガも宮崎県佐土原町の福田農園さんを使用しています。生にんにくは宮崎県佐土原町(株)MOMIKIさん使用、生ショウガも宮崎県佐土原町の福田農園さんを使用しています。'} />
          <SubLayout title={'簡単調理で本場のハネを再現できます'} src={image4} content={'フライパンを熱し油を適量ひきます、火を消して凍ったまま餃子を並べて強火で水３００ccを餃子の上から全体に注いでください、フタをして7分前後でパチパチと水分が飛んだら出来上がりです。「目安に10〜20個位で３００ccフライパン28センチ」'} />
        ...
        <section className="bg-black text-white ">
          <div className="m-8 text-center lg:m-24">
            <h1 className="p-8 text-4xl" id={"no3"}>全ては、一軒の居酒屋から。</h1>
            <BasicLayout src={image6} content={'横浜で本格宮崎料理「いっちゃが」を営んでおります。ムービル前の路地を進むと出現する隠れ家。宮崎出身のオヤジさんによる料理＆集めに集めた銘酒を自信を持ってご提供。長年、地元の方々からご愛顧いただきスタッフはもちろん常連さんとも仲良くなれる気さくな大人が夜な夜な集う、温かいお店。'} />
            <ReverseBasicLayout src={image7} content={'コロナ禍で売上が壊滅的な状況であります。ただ、「ピンチはチャンス」と捉えて今まで着手できていなかった通信販売の部分に力を入れていきます。当店で長年人気だった宮崎餃子をご自宅でも楽しめるように冷凍の商品として販売！'} />
          </div>
        </section>
